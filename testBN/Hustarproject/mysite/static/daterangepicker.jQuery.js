$.fn.daterangepicker = function(settings){
	...
	var options = $.extend({
		...
		presetRanges: [
			...
			{text: '1주일', dateStart: 'today-7days', dateEnd: 'today' },
			{text: '1개월', dateStart: 'today-1month', dateEnd: 'today' },
			{text: '3개월', dateStart: 'today-3month', dateEnd: 'today' },
			{text: '6개월', dateStart: 'today-6month', dateEnd: 'today' },
			{text: '1년', dateStart: 'today-1year', dateEnd: 'today' },
			{text: '3년', dateStart: 'today-3year', dateEnd: 'today' },
			{text: '5년', dateStart: 'today-5year', dateEnd: 'today' }
		],
		presets: {
			dateRange: '<img src="/js/datePicker/css/ui-lightness/images/ui-bg_highlight-btn01.png">',
		},
		rangeStartTitle: '시작일',
		rangeEndTitle: '종료일',
		nextLinkText: '전월',
		prevLinkText: '차월',
		doneButtonText: '<img src="/js/datePicker/css/ui-lightness/images/ui-bg_highlight-btn02.png">',
		earliestDate: Date.parse('-15years'), //earliest date allowed
		latestDate: Date.parse('+15years'), //latest date allowed
		rangeSplitter: '-', //string to use between dates in single input
		dateFormat: 'yy-mm-dd', // date formatting. Available formats: http://docs.$.com/UI/Datepicker/%24.datepicker.formatDate
	...
	var rpPresets = (function(){
		...
		$.each(options.presets, function(key, value) {
			$('<li class="ui-daterangepicker-'+ key +' preset_'+ x +' ui-helper-clearfix ui-corner-all"><a href="#" class="btn_01">'+ value +'</a></li>')
			.appendTo(ul);
			x++;
		});
		...
		ul.find('li').hover(
			...
			.click(function(){
				...
				$(this).addClass('ui-state-active').clickActions(rp, rpPickers, doneBtn);
				return false;
			});
		return ul;
	})();
	...
	$.fn.clickActions = function(rp, rpPickers, doneBtn){

		if($(this).is('.ui-daterangepicker-specificDate')){
			doneBtn.hide();
			rpPickers.show();
		...
		else if($(this).is('.ui-daterangepicker-allDatesBefore')){
			doneBtn.hide();
			rpPickers.show();
		...
		else if($(this).is('.ui-daterangepicker-allDatesAfter')){
			doneBtn.hide();
			rpPickers.show();
