...
int main()
{
    ...
    Point center = image1.size()/2; //영상의 중심 좌표, size()함수는 크기를 알아낸다
    circle(image1, center, 100, Scalar(255), -1);   //중심에 원
    rectangle(image2, Point(0,0), Point(150, 300), Scalar(255), -1);    //흰 사각형 그리기 
