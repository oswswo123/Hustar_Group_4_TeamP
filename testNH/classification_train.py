...
def train(dataloader_list, test_dataloader, model_path, pretrained_model, save_model, device, seed_val, epochs, fold_length):
    ...
    elif pretrained_model == "klue/roberta-large":
        pretrained = AutoModel.from_pretrained("nile/roBERTa-large-finetuned-wholemasking20")
    else:
        pretrained = AutoModel.from_pretrained("nile/koBERT-finetuned-wholemasking20")
...
def main():
    etc_modules.set_seed()

    json_file = open("./classification_train_config.json", encoding="utf-8")
